...
router.get("/get", (req, res) => {
  var query = `select p.id,p.name,p.description,p.image,p.price,p.status,p.sold,p.quantity,c.name as categoryName from product as p INNER JOIN category as c where p.categoryId=c.id`;
